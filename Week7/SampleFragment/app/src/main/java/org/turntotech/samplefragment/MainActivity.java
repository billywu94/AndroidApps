...
//	TODO: Modify this function to include your button and replace the container with your new fragment.
	public void selectFrag(View view) {
	    ...
	    }else if(view == findViewById(R.id.button2)){ //changed else to else if(view == findViewById(R.id.button2)
	    	fragmentTransaction.replace(R.id.fragment_container, new FragmentTwo()).commit();
	    }else if (view == findViewById(R.id.button3)){ //3.21.17
			fragmentTransaction.replace(R.id.fragment_container, new YourFragment()).commit();
		}
	}
